...
import 'package:instacare/screens/openShiftsFlow/view/confirmedShiftsScreen.dart';
import 'package:instacare/screens/openShiftsFlow/view/openShiftsScreen.dart';
                ...
                children: [
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: (){
                        toPushNavigator(context: context,PageName: const OpenShiftsScreen());
                      },
                    ),
                  ),
                  Gap(5.w),
                  Expanded(
                    child:  InkWell(
                      ...
                      onTap: (){
                        toPushNavigator(context: context,PageName:const ConfirmedShiftsScreen());
                      },
                    ),
                  )
                ],
