...
import 'package:instacare/screens/dashBoardFlow/view/peopleDashBoardFlow/view/pointsScreen.dart';
import 'package:instacare/screens/dashBoardFlow/view/peopleDashBoardFlow/view/reviewsScreen.dart';
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                            ...
                            onTap: () {
                              CommonBottonSheet(childView: ReviewsScreen(context), context: context);
                            },
                          ),
                          SizedBox(
                            height: Reponsive_.crosslength * 0.02,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            onTap: () {
                              ...
                              //TODO Instacare flow
                              toPushNavigator(context: context,PageName: PointsScreen());
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        Checkbox(
                                                                          ...
                                                                          onChanged:
                                                                              (bool? newValue) {
                                                                            peopleController.shiftValue.value =
                                                                                newValue!;
                                                                          },
                                                                        ),
                                                                        InterText(
                                  ...
                                  childView: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CommonDropDown(
                                            context: context,
                                            hint: 'Select Uniform Size',
                                            list: profileController
                                                .uniformSizeArr,
                                            mycontrollerValue:
                                                profileController.selectedSize,
                                            color: AppColors.backGroundColor),
                                        SizedBox(
                                          height:
                                              Reponsive_.crosslength * 0.012,
