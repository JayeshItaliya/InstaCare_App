...
import 'package:instacare/screens/openShiftsFlow/controller/openShiftsScreenController.dart';
import 'package:instacare/screens/openShiftsFlow/view/scheduleFilterScreen.dart';

class ConfirmedShiftsScreen extends StatefulWidget {
  const ConfirmedShiftsScreen({Key? key}) : super(key: key);

  @override
  State<ConfirmedShiftsScreen> createState() => _ConfirmedShiftsScreenState();
}

class _ConfirmedShiftsScreenState extends State<ConfirmedShiftsScreen> {
      ...
      bottomSheet: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.verified_user,color: Color.fromRGBO(126, 230, 155, 1)),
                MontserratText(
                  text: "Assigned",
                  fontSize: 12,
                  fontWeight: FontWeight.w400,
