...
import 'package:instacare/screens/openShiftsFlow/controller/scheduleFilterScreenController.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          commonDropDown(
            context,
            scheduleFilterController.facilities,
            scheduleFilterController.facilitiesValue,
              popUpKey1
          ),
          Gap(15),
          commonDropDown(
            context,
            scheduleFilterController.employeeName,
            scheduleFilterController.employeeNameValue,
              popUpKey2
          ),
          Gap(15),
          commonDropDown(
            context,
            scheduleFilterController.role,
            scheduleFilterController.roleValue,
              popUpKey3
          ),
          Gap(20),
          InterText(
                ...
                child: InkWell(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:selectedShiftMorning==true?AppColors.buttonColor:AppColors.greenDark,
                      border:selectedShiftMorning==false?Border.all(color: AppColors.buttonColor,width: 2):null,
                      borderRadius: BorderRadius.circular(30)
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Image.asset(AppAssets.sun,color: selectedShiftMorning==false?Color.fromRGBO(126, 209, 230, 1):null),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            InterText(
                              text:"Morning Shifts",
                              color:selectedShiftMorning==true?AppColors.white:AppColors.black,
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    height: cx.height/11,
                    decoration: BoxDecoration(
                        color:selectedShiftAfternoon==true?AppColors.buttonColor:AppColors.greenDark,
                        border:selectedShiftAfternoon==false?Border.all(color: AppColors.buttonColor,width: 2):null,
                        borderRadius: BorderRadius.circular(30)
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        Column(
                          ...
                          children: [
                            InterText(
                              ...
                              color:selectedShiftAfternoon==true?AppColors.white:AppColors.black,
                              fontWeight: FontWeight.w600,
                              fontSize: 13,
                            ),
                            InterText(
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    height: cx.height/11,
                    decoration: BoxDecoration(
                        color:selectedShiftNight==true?AppColors.buttonColor:AppColors.greenDark,
                        border:selectedShiftNight==false?Border.all(color: AppColors.buttonColor,width: 2):null,
                        borderRadius: BorderRadius.circular(30)
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            InterText(
                              text:"Night Shifts",
                              color:selectedShiftNight==true?AppColors.white:AppColors.black,
                              fontWeight: FontWeight.w600,
                              fontSize: 13,
                            ),
                            InterText(
